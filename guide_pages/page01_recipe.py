...
整体设计模板必须采用成熟爆款菜谱海报风，版式和气质沿用当前满意版本：整张上半部分是一张连续主菜背景照片，顶部双层标题区、黄条和左右信息卡都直接压在这张照片上，下半部分是“5步出锅”步骤条，底部是一整条收藏与关注横条。不要极简，不要杂志风，不要大面积留白，必须是信息很多但一眼就想收藏的高密度爆款图文模板。
