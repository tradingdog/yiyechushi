...
from tools.weixin_mp_publish import (  # noqa: E402
    ...
    DEFAULT_AFTER_COVER_EDITOR_WAIT_MS,
    DEFAULT_COVER_CROP_DRAG_START_X,
    DEFAULT_COVER_CROP_DRAG_START_Y,
    DEFAULT_COVER_CROP_DRAG_END_Y,
    DEFAULT_URL_KEYWORD,
...
def resolve_settings(args: argparse.Namespace) -> WeixinPublishSettings:
    ...
    return WeixinPublishSettings(
        ...
        after_cover_editor_wait_ms=DEFAULT_AFTER_COVER_EDITOR_WAIT_MS,
        cover_crop_drag_start_x=DEFAULT_COVER_CROP_DRAG_START_X,
        cover_crop_drag_start_y=DEFAULT_COVER_CROP_DRAG_START_Y,
        cover_crop_drag_end_y=DEFAULT_COVER_CROP_DRAG_END_Y,
